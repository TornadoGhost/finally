...
The keys live in `.claude/settings.json` (project) or `/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/settings.json` (global) — **not** in `.planning/config.json`:

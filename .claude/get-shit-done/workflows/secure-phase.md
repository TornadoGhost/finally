...
```
Agent(
  prompt="Read /Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/templates/SECURITY.md`

...
INSTALL_JS_GLOBAL="/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.

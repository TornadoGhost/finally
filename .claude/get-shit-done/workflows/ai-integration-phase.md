...
<required_reading>
@/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/references/ai-frameworks.md
@/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/agents/gsd-eval-planner.md for instructions.

...
```bash
INIT=$(node "/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/templates/spec.md.

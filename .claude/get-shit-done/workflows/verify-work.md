...
<template>
@/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/workflows/diagnose-issues.md

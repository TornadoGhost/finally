...
```bash
INIT=$(node "/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/bin/gsd-tools.cjs" commit \

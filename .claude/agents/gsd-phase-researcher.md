...
@/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```

...
<required_reading>
Read `/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>

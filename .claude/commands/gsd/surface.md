...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/commands/gsd
AGENTS_DIR=/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/agents
```
...
<execution_context>
Surface state file: `/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/skills/.gsd-surface.json`
Install profile marker: `/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/skills/.gsd-profile`
Engine module: `/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/nadhob/AI/Courses tasks by Ed Donner/finally/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
